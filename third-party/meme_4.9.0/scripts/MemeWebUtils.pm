...
unless ($@) {
  Log::Log4perl::init('/home/yuhao/meme/etc/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.cgi.utils');
}

my $MOTIF_DB_INDEX = '/home/yuhao/meme/etc/motif_db.index';
my $template_dir = '/home/yuhao/meme/web/cgi-bin';
my $service_invocation_log_dir = '/home/yuhao/meme/LOGS';
my $tmpdir = '';
...
sub make_submission_form_top {
  ...
  $content = 
      ...
      $indent.$tab.$tab.$tab.$tab.$tab.$tab.$tab.$tab.$tab."Version 4.9.0\n".
      $indent.$tab.$tab.$tab.$tab.$tab.$tab.$tab.$tab."</center>\n".
...
sub verify_opal_job {
  ...
  unless (eval {$result->fault}) {
    ...
    my $query_url = "http://meme.nbcr.net/meme/cgi-bin/querystatus.cgi";
