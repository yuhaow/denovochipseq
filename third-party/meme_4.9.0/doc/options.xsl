...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="command-option[@name='alpha']"> 
    <code>--alpha <i>&lt;float&gt;</i></code>
  ...
  <xsl:template match="command-option[@name='beta']"> 
    <code>--beta <i>&lt;float&gt;</i></code>
  ...
  <xsl:template match="command-option[@name='bigwig']"> 
    <code>--bigwig</code>
  ...
  <xsl:template match="command-option[@name='est-seq-size']">
    <code>--est-seq-size &lt;n&gt;</code>
  ...
  <xsl:template match="command-option[@name='max-strand']">
    <code>--max-strand</code>
  ...
  <xsl:template match="command-option[@name='motif-pthresh']">
    <code>--motif-pthresh <i>&lt;pv&gt;</i></code>
  ...
  <xsl:template match="command-option[@name='numbins']">
    <code>--numbins &lt;n&gt;</code>
  ...
  <xsl:template match="command-option[@name='dfile']">
    <code>--dfile <i>&lt;description file&gt;</i></code>
    - Specifies a file containing a description to be stored in the output.
  </xsl:template>

  <xsl:template match="command-option[@name='png']">
    <code>--png</code>
    - Output images in PNG format.
  </xsl:template>

  <xsl:template match="command-option[@name='eps']">
    <code>--eps</code>
    - Output images in EPS format.
  </xsl:template>
  ...
  <xsl:template match="command-option[@name='output-ethresh']">
    <code>--output-ethresh <i>&lt;float&gt;</i></code>
 ...
 <xsl:template match="command-option[@name='thresh']">
    <code>--thresh<i>&lt;float&gt;</i></code>
 ...
 <xsl:template match="command-option[@name='qv-thresh']">
    <code>--qv-thresh</code>
  ...
  <xsl:template match="command-option[@program='create-priors' and @name='psp']"> 
    <code>--psp</code>
  ...
  <xsl:template match="command-option[@program='ame' and @name='method']"> 
    <code>--method<i>&lt;fisher|mhg|4dmhg|ranksum|linreg|spearman&gt;</i></code> 
  ...
  <xsl:template match="command-option[@program='ame' and @name='scoring']"> 
	  <code>--scoring<i>&lt;avg|max|sum|totalhits&gt;</i></code> 
    ...
    If using <code>totalhits</code> mode, please see also<code>--pvalue-threshold</code>
  </xsl:template>

  <xsl:template match="command-option[@program='ame' and @name='rsmethod']"> 
    <code>--rsmethod<i>&lt;better|quick&gt;</i></code> 
    - Select whether to use a proper ranksum test (<code>better</code>) or a faster
    heuristic. Default is to use the proper test.
  </xsl:template>
 
  <xsl:template match="command-option[@program='ame' and @name='poslist']"> 
    <code>--poslist<i>&lt;fl|pwm&gt;</i></code> 
  ...
  <xsl:template match="command-option[@program='ame' and @name='log-fscores']"> 
    <code>--log-fscores</code> 
    - For linear regression and spearman tests only: regress using
    ln(fluorescence score), rather than the score directly.
  </xsl:template>

  <xsl:template match="command-option[@program='ame' and @name='log-pwmscores']"> 
    <code>--log-pwmscores</code> 
    - For linear regression and spearman tests only: regress using
    ln(pwm score), rather than the score directly.
  </xsl:template>

  <xsl:template match="command-option[@program='ame' and @name='normalise-affinity']"> 
    <code>--normalise-affinity</code> 
  ...
  <xsl:template match="command-option[@program='ame' and @name='linreg-switchxy']"> 
    <code>--linreg-switchxy</code> 
    - Make the x-points fluorescence scores and the y-points PWM scores.
    Only relevant for Spearman and Linear Regression tests.
  </xsl:template>

  <xsl:template match="command-option[@program='ame' and @name='fl-threshold']"> 
    <code>--fl-threshold<i>&lt;p-value&gt;</i></code> 
  ...
  <xsl:template match="command-option[@program='ame' and @name='pwm-threshold']"> 
    <code>--pwm-threshold<i>&lt;score&gt;</i></code> 
  ...
  <xsl:template match="command-option[@program='fimo' and @name='psp']"> 
