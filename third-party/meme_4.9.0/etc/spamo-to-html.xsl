...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="sequence-summary">
    ...
    <div class="box" >
      <table class="preview">
        <tr>
          <th>Name&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_name')"/></th>
          <th>Last Modified&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_last_modified')"/></th>
          <th>Loaded&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_loaded')"/></th>
          <th>Too Short&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_too_short')"/></th>
          <th>No Primary&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_no_primary')"/></th>
          <th>Too Similar&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_too_similar')"/></th>
          <th>Used&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_seqs_used')"/></th>
        </tr>
        <tr>
  ...
  <xsl:template name="primary-summary">
    ...
    <div class="box" >
      <table class="preview">
        <tr>
          <th>Name&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_primary_motif_name')"/></th>
          <th>Preview&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_primary_motif_preview')"/></th>
          <th>Significant Secondaries&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_primary_motif_sig_motifs')"/></th>
          <th>List&nbsp;<div class="help" 
              onclick="help_popup(this, 'pop_primary_motif_sig_list')"/></th>
        </tr>
        <xsl:for-each select="spamo/primary_motif">
  ...
  <xsl:template name="secondary-motif">
    ...
    <div class="box" >
	  ...
	  <th><i>E</i>-value <div class="help" onclick="help_popup(this, 'pop_evalue')"/></th>
        </tr>
        <tr>
          <td>
            <xsl:call-template name="motif-logo">
      ...
      <table>
        <tr>
          ...
          <th>&nbsp;</th><th colspan="2">Significant Motif Spacings (<i>p</i>&lt;<xsl:value-of select="/spamo/model/bin_pvalue_cutoff"/>)&nbsp;<div class="help" onclick="help_popup(this, 'pop_spacings')"/></th><th>&nbsp;</th>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="details" style="vertical-align:top">
            ...
            <h4>Motif Database&nbsp;<div class="help" onclick="help_popup(this, 'pop_motifdb')"/></h4>
          ...
          <tr>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <table>
		  <tr>
		    <th>Secondary Motif&nbsp;<div class="help" onclick="help_popup(this, 'pop_secondary')"/></th>
		    <th><i>E</i>-value <div class="help" onclick="help_popup(this, 'pop_evalue')"/></th>
		  </tr>
		  <tr>
		    <td>
      ...
      <table >
        ...
        <tbody>
          <xsl:for-each select="$spacing_set">
            <xsl:sort select="@bin" data-type="number" order="ascending"/>
