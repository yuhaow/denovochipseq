  ...
  <xsl:template name="preview">
    ...
    <div class="box">
      <table class="preview">
        <thead>
          <tr>
            <td  style="min-width:5em;"><h4>Name&nbsp;<a href="#qm_name_doc" class="help"><div class="help"/></a></h4></td>
            <xsl:if test="/tomtom/queries/query_file/query/motif/@alt">
              <td  style="min-width:8em;"><h4>Alt. Name&nbsp;<a href="#qm_alt_doc" class="help"><div class="help"/></a></h4></td>
            </xsl:if>
            <xsl:if test="/tomtom/queries/query_file/query/motif/@url">
              <td  style="min-width:8em;"><h4>Website&nbsp;<a href="#qm_website_doc" class="help"><div class="help"/></a></h4></td>
            </xsl:if>
            <td  style="min-width:9em;"><h4>Preview&nbsp;<a href="#qm_preview_doc" class="help"><div class="help"/></a></h4></td>
            <td  style="min-width:9em;"><h4>Matches&nbsp;<a href="#qm_matches_doc" class="help"><div class="help"/></a></h4></td>
            <td  style="min-width:6em;"><h4>List&nbsp;<a href="#qm_list_doc" class="help"><div class="help"/></a></h4></td>
          </tr>
        </thead>
        <tbody>
          <xsl:for-each select="/tomtom/queries/query_file/query">
  ...
  <xsl:template name="targets">
    ...
    <div class="box">
      <table class="targets">
        <thead>
          <tr>
            <td style="min-width:8em;"><h4>Database&nbsp;<a href="#tdb_database_doc" class="help"><div class="help"/></a></h4></td>
            <td style="min-width:8em;"><h4>Number of Motifs&nbsp;<a href="#tdb_contains_doc" class="help"><div class="help"/></a></h4></td>
            <td style="min-width:8em;"><h4>Motifs Matched&nbsp;<a href="#tdb_matched_doc" class="help"><div class="help"/></a></h4></td>
          </tr>
        </thead>
        <tbody>
